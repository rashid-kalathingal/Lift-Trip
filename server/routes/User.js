...
router.get('/getrides',userVerifyToken,riderController.getrides)
...
router.put('/changeName/:id',userVerifyToken, userController.changeName);
router.put('/changeWallpapper/:id',userVerifyToken, userController.changeWallpapper);
router.put('/changeEmail/:id',userVerifyToken, userController.changeEmail);
router.put('/changeNumber/:id',userVerifyToken, userController.changeNumber);
...
router.post('/submitReview',userVerifyToken, userController.submitReview);
...
router.put('/blockUserbyUser',userVerifyToken, chatController.blockUserbyUser);
router.put('/comformRide',userVerifyToken, userController.comformRide);

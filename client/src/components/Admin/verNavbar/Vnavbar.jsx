...
import { FiBarChart2, FiUsers, FiCheckSquare, FiAlertCircle, FiArrowLeft } from 'react-icons/fi';
      ...
      <div className={`${open ? 'w-72' : 'w-20'} duration-300 h-screen p-5 pt-8 bg-dark-purple relative`}>
        ...
        <ul className='pt-6'>
          ...
          >
            ...
            <span className={`${!open && 'hidden'} origin-left duration-200`}><Link to="/admin">Dashboard</Link></span>
          </li>
          ...
          >
            ...
            <span className={`${!open && 'hidden'} origin-left duration-200`}><Link to="/admin/users">Users</Link></span>
          </li>
          ...
          >
            ...
            <span className={`${!open && 'hidden'} origin-left duration-200`}><Link to="/admin/verification">Verifications</Link></span>
          </li>

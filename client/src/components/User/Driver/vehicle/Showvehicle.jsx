    ...
    <div className="flex">
      ...
      <div className="flex-1">
        <img
          src={image}
          alt="Image"
          className="w-full h-128 mt-2 rounded-lg"
        />
      </div>
      ...
      <div className="flex-1 p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                <label htmlFor="vehicleInsurance" className="block text-sm font-medium text-gray-700">
                  Vehicle Insurance
                </label>
                <img
      ...
      >
        ...
        <div className="p-6">
          ...
          <Allvehicles userId={user._id} onVehicleSelect={handleVehicleSelect} onClose={closeMyVehiclesModal} />
        </div>
      </Modal>
    </div>
  );

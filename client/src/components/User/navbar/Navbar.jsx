...
const Navbar = () => {
 ...
 async function fetchData() {
  try {
    ...
    //const data = await userInstance.get(`/getProfile/${user._id}`, options);
    const connection = await userInstance.get(`/getconnections/${user._id}`, options);
    console.log(connection.data,"??>>>");
    
   // setDisplay(data.data.displayPic[0]); 
    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl mx-auto p-4">
        <div className="flex items-center justify-between">
          ...
          <NotificationDropdown data={verconnection}/>
          <Link to="/wallet">
          ...
          {!user ? (
            ...
            <>
              ...
              >
                ...
                <span className="top-4 right-32 absolute  w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
              </button>
              {showDropdown && (
                <div
                ...
                >
                  <ul className="pt-2" aria-labelledby="user-menu-button">
                    ...
                    <li>
                      ...
                      >
                        <FiLogOut className="inline-block w-5 h-5 mr-2" /> Sign out
                      </a>
                    </li>
                  </ul>
                </div>

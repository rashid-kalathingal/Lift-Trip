...
const DropdownNotification = ({ data, onClick }) => {
  ...
  const handleAccept = async (Id, element) => {
    ...
    try {
      ...
      if (response) {
        Swal.fire('Success', 'Making a New Connection', 'success');
      }
    } catch (error) {
      console.log(error);
    }
  ...
  //  // Use Socket.io to listen for incoming notifications
  //  useEffect(() => {
  //   socket.on("notification", (notificationData) => {
  //     // Handle the incoming notification here
  //     console.log("New notification received:", notificationData);
  //     // You can update your notification state or display the notification to the user as needed.
  //   });

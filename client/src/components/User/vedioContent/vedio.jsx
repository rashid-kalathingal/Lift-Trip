...
const Video = () => {
  return (
    <div className="features  bg-zinc-100 dark:bg-0d084d py-8 min-h-max">
      <div className="container  flex flex-wrap items-center gap-200">
        <div className="item flex-2 mt-14">
          <h1 className="font-bold mb-10 from-neutral-900">
            Hitchhiking offers a unique opportunity to embrace adventure,
            cultural exchange, and camaraderie with fellow travelers and locals
            alike.
          </h1>
          ...
          <p className="text-gray-600 dark:text-sky-950 mb-10 ml-8 mt-6">
            Hitchhiking is a budget-friendly way to travel as it allows you to
            save on transportation costs like fuel, public transportation fares,
            or rental fees.
          </p>
          ...
          <p className="text-gray-600 dark:text-sky-950 ml-8 mt-6">
            Hitchhiking allows you to meet a diverse range of people, forming
            connections and making new friends from different backgrounds.
          </p>
        </div>

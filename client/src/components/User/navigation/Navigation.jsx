...
const Navigation = () => {
  ...
  return (
    ...
    <motion.div
      className='bg-stone-50 h-128 flex justify-center items-center'
      ref={ref}
      ...
      <div className='bg-blue-100 w-9/12 px-8 py-24 flex flex-wrap justify-between space-x-8 items-center'>
        <div className='text-indigo-950 flex  items-center'>
          <p className='max-w-lg mb-8'>
            ...
            together at crossroads".
            "Two worlds converge as a thumb meets a ride, forging connections
            unforeseen".
            "Hitchhiking: a tapestry of chance encounters, weaving tales of
            trust and adventure".
            "Through outstretched thumbs and fleeting rides, hitchhiking
            paints stories of human bonds."
          </p>
        </div>

...
const Driver = () => {
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        {' '}
        <Date onDateSelection={handleDateSelection} />
        <ToastContainer />
      </div>
      <div className="mb-6">
        <VehicleData onVehicleSelect={handleSelectedVehicle} />
      </div>
      <div className="mb-6">
        <DriverUser header={'Driver Details'} />
      </div>
      <div className="mb-6">
        <Instruction onInstructionDataChange={handleInstructionDataChange} />
      </div>
      <div className="flex justify-center items-center">
        <button
          className="p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800"
          onClick={handleRegisterRide}>
          <div className="flex justify-center items-center">
            <a
              href="#_"
